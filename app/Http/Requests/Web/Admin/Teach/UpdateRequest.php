    ...
    return [
      ...
      "class_id" => [
        ...
        function($attribute, $value, $fail) {
          ...
          $teach = Teach::where('id', '!=', $teach->id)->where('teacher_id', $teacher_id)->where('class_id', $class_id)->where('school_year_id', $school_year_id)->where('semester', $semester)->first();
          if ($teach) {
      ...
      "lesson_id.*" => [
        ...
        function($attribute, $value, $fail) {
          ...
          $teachDetail = TeachDetail::where('teach_id', '!=', $teach->id)->where('class_id', $class_id)->where('school_year_id', $school_year_id)->where('semester', $semester)->first();
          if ($teachDetail) {
