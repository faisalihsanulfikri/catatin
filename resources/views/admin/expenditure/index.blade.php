...
@section("breadcrumb")
  <li class="breadcrumb-item active"><a href="{{ route('admin.expenditure.index') }}">Pengeluaran</a></li>
@endsection
    ...
    <div class="container">
      ...
      <div class="widget-content-area br-4 mt-4">
        <div class="widget-one">
            <h5 class="title-page">Pengeluaran</h5>
        </div>
      </div>
          ...
          <div class="widget-content widget-content-area br-6">
            <div class="row">
              <div class="col-6" style="text-align: left;">
                <span><strong>Tabel Pengeluaran</strong> </span>
              </div>
              <div class="col-6" style="text-align: right;">
                <a href="{{ route('admin.expenditure.new') }}" class="action-btn btn btn-primary pull-right">
  ...
  <script type="text/javascript">
    let templateData = {
        ...
        amount: function(row, type, data) {
          ...
          let urlDetail = '{{ route("admin.expenditure.edit", ["income_id" => ":income_id"]) }}';
    ...
    templateData.element.tableCustom = templateData.element.tableCustom.DataTable({
      ...
      stateSave: true,
			...
			ajax: {
				...
				url: '{{ route("datatable.admin.expenditure.index") }}',
				type: 'GET',
			},
			columns: [
