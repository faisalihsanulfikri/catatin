...
@section("subtitle", "Pemasukan Baru")

@section("breadcrumb")
  <li class="breadcrumb-item"><a href="{{ route('admin.income.index') }}">Pemasukan</a></li>
  <li class="breadcrumb-item active" aria-current="page"><span>Pemasukan Baru</span></li>
@endsection
    ...
    <div class="container">
      ...
      <div class="widget-content-area br-4 mt-3">
        <div class="widget-one">
          <h5 class="title-page">Pemasukan Baru</h5>
        </div>
      </div>        
            ...
            <div class="widget-header">
              <div class="row">
                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                  <h4> Buat Pemasukan baru disini </h4>
                </div>
              </div>
            </div>
